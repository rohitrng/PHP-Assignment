...
<div class="dashboardmainWrapper"> 
  ...
  <div class="dashboardloginWrapper adminBx">
    <div class="dashboardcenterWrapper">
      ...
      <tr><?php echo form_open('Admin/update'); ?>
            <?php echo form_hidden('id',$data->u_id); ?>
        <td><?php echo form_input(['name'=>'username','value'=>$data->u_username]) ; ?></td>
        <td><?php echo form_input(['name'=>'email','value'=>$data->u_email]) ; ?></td>
        <td><?php echo form_input(['name'=>'mobile','value'=>$data->u_mobile]) ; ?></td>
        <td><?php echo form_submit(['name'=>'submit','value'=>'Submit','class'=>'btnStyle2']); ?></td>
